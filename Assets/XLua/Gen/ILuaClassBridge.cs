...
{
    public class ILuaClassBridge : LuaBase, ILuaClass
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new ILuaClassBridge(reference, luaenv);
		}
		
		public ILuaClassBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int ILuaClass.add(int a, int b)
		{
